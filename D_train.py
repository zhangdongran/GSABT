...
def main():
    ...
    train_loader, valid_loader, test_loader, f_mean, f_std, s_mean, s_std, nodes, f_nodes, s_nodes, matrix, log = utils.d_bjbike(args, log)
    ...
    from model.D_MPBTCN import Network
